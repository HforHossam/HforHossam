...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/hforhossam)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/hforhossam
```

A live public deployment of this template is available at [https://hforhossam.templates.workers.dev](https://hforhossam.templates.workers.dev)
